...
//   - open https://yourngrokurl.ngrok.io/login in your browser
// - deploy with now:
...
//   - run `now alias your-now-subdomain`
//   - update the callback URL to your subdomain
//   - log into https://your-now-subdomain.now.sh/
'use strict';
